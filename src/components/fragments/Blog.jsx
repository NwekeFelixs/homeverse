...
import { IoPerson, IoPricetags, IoCalendar } from 'react-icons/io5';
import blogImg1 from '../img/blog-1.png';
      ...
      <div className="container">
        ...
        <ul className="blog-list has-scrollbar">
          <li>
            <div className="blog-card">
              <figure className="card-banner">
                <img src={blogImg1} alt="The Most Inspiring Interior Design Of 2021" className="w-100" />
              </figure>
          ...
          <li>
            <div className="blog-card">
              <figure className="card-banner">
                <img src={blogImg2} alt="Recent Commercial Real Estate Transactions" className="w-100" />
              </figure>
              <div className="blog-content">
                <div className="blog-content-top">
                  <ul className="card-meta-list">
          ...
          <li>
            <div className="blog-card">
              <figure className="card-banner">
                <img src={blogImg3} alt="Renovating a Living Room? Experts Share Their Secrets" className="w-100" />
              </figure>
              <div className="blog-content">
                <div className="blog-content-top">
                  <ul className="card-meta-list">
